...
const analysisSchema = {
  ...
  properties: {
    ...
    companyType: {
      ...
      description:
        'Classify the employer/opportunity source. Use Staffing Agency for recruiters/staffing vendors, contract placement firms, Dice-style recruiter postings, and Crossing Hurdles-style agency posts. Use Talent Network for talent communities, matching platforms, candidate marketplaces, future opportunities, Workerbee-style networks, and profile-building pools. Use Suspicious Posting for stealth/confidential/no-identity postings, unrealistic compensation, minimal company information, or generic copied responsibilities. This must not change fitScore or applicationRequirements, but it can inform interviewChance and recommendation.',
    },
    opportunityQuality: {
      type: 'string',
...
- companyType must not affect fitScore or applicationRequirements. Use "Direct Employer" when the company appears to be hiring for its own product/team, "Staffing Agency" for recruiters/staffing vendors and contract placement firms including Dice-style recruiter postings and Crossing Hurdles-style agency posts, "Talent Network" for talent communities, Workerbee-style matching platforms, candidate marketplaces, join-our-network/talent-pool/future-opportunity/profile-building posts, "Suspicious Posting" for stealth startup/confidential/no-company-identity postings, unrealistic compensation, minimal company information, or generic copied responsibilities, "Consulting" for consulting/client-services firms, "Startup" for startup employers, and "Unknown" when unclear.
- Employer type must affect interviewChance but not fitScore: Direct Employer has no penalty; Staffing Agency should usually be capped around "5-10%" because of the staffing/recruiting layer before the client; Talent Network should usually be capped around "3-7%" because of candidate-pool/marketplace conversion risk; Suspicious Posting should usually be capped around "3-7%" or lower because of posting quality and credibility risk.
...
- shortReasoning must mention the employer-type conversion layer when companyType is Staffing Agency, Talent Network, or Suspicious Posting.
...
function getReasoningDetails(analysis) {
  ...
  if (analysis.companyType === 'Staffing Agency') {
    details.push('the staffing/recruiting layer lowers conversion before the client screen');
  } else if (analysis.companyType === 'Talent Network') {
    details.push('the candidate pool or marketplace layer lowers conversion before a hiring-manager screen');
  } else if (analysis.companyType === 'Suspicious Posting') {
    details.push('posting quality and credibility concerns lower expected conversion');
  }
